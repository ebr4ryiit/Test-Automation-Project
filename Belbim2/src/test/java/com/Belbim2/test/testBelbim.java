...
public class testBelbim extends Driver {
    Methods methods;

    @Test
    public void basariliDurumTest() {
        methods = new Methods();
        ...
        methods.waitBySeconds(5); // reCAPTCHA'yı manuel olarak tamamlamak için 10 saniye bekleyin
